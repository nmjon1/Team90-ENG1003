...
var lookup=
{AB:"a", BAAA: "b", BABA:"c", BAA:"d",A:"e", AABA:"f", BBA:"g", AAAA:"h", AA: "i", ABBB:"j", BAB: "k", ABAA:"l", BB:"m", BA:"n", BBB:"o", ABBA:"p", BBAB:"q", ABA:"r", AAA:"s", B:"t", AAB:"u", AAAB:"v", ABB:"w", BAAB:"x", BABB:"y", BBAA:"z", BBBB:"0", ABBBB:"1", AABBB:"2", AAABB:"3", AAAAB:"4", AAAAA:"5", BAAAA:"6", BBAAA:"7", BBBAA:"8", BBBBA:"9", BABBA:"(", BABBAB:")", ABAABA:'“', BAAAB: "=", ABBBBA: "'", BAABA:'/', ABABA:"+", BBBAAA:":", ABABAB:".", BBAABB:",", AABBAA:"?", BAAAAB:"-", ABBABA:"@", AAABAAB:"$", AABBAB:"_", BABABB:"!", ABAB:"\n", AAABAB:"End transmission"};
...
function compare_arrays(a,b) {
    ...
    for (i = 0; i < a.length; i++) {
        // We loop through each element, checking that the elements are not different.
        if (a[i] != b[i]) {
            return false
        }
    }
